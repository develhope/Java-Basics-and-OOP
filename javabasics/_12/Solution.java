...
public class Solution {
    ...
    public static double exercise1(String text, double expectedScore) {
        ...
        int baseScore = text.length();
        yourScore = Math.min(baseScore, 20);
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        // Calculate the base score based on mealType and weight
        switch (mealType) {
            case "sandwich":
            ...
            default:
                ...
                return yourMealScore; // Return the default value if the mealType is invalid
        }
