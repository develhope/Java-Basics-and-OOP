...
public class Solution {
    ...
    private static void exercise1() {
        ...
        // Check if the conditions for "Comfortable clothes" are met
    ...
    private static void exercise3() {
        ...
        // Calculate the percentage of our test score
        double percentage = (ourTestScore / maxTestScore) * 100;

        // Check if 'isTestRetry' is true and the percentage is greater than 70%
        // If true, cap the maximum grade at "C"
        if (isTestRetry && percentage > 70) {
