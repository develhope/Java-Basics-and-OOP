...
public class Solution {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        int porridgeHeatInCentigrade = 60; // Set the value to 60
    ...
    private static void exercise3() {
        ...
        // Check if ourDouble is greater than 2.5
        if (ourDouble > 2.5) {
            System.out.println("Greater than");
        } else {
            // Add 1.0 to 'ourDouble'
            ourDouble += 1;
    ...
    private static void exercise4() {
        ...
        // Check age using if, else if, and else statements
        if (employeeAge >= 65) {
